    ...
    $.fn.Tabledit = function(options) {
        ...
        var Edit = {
            ...
            submit: function(td) {
                ...
                var ajaxResult = ajax(settings.buttons.edit.action, $(td).parent('tr'));
        ...
        var Delete = {
            ...
            submit: function(td) {
                ...
                // Send AJAX request to server.
                var ajaxResult = ajax(settings.buttons.delete.action, $(td).parent('tr'));
            ...
            restore: function(td) {
                ...
                $(td).parent('tr').find('input.tabledit-identifier').attr('disabled', false);
                // Send AJAX request to server.
                var ajaxResult = ajax(settings.buttons.restore.action, $(td).parent('tr'));
                // Disable identifier hidden input.
                $(td).parents('tr').find('input.tabledit-identifier').attr('disabled', true);
        ...
        function ajax(action, tr)
        {
            ...
            var serialize = serialized ;// $table.find('.tabledit-input').serialize() + '&action=' + action;
        ...
        if (settings.editButton) {
            ...
            $table.on('click', 'button.tabledit-save-button', function(event) {
                if (event.handled !== true) {
                    ...
                    $(this).closest('tr').find('.tabledit-input').each(function(){
                    	var parentTR = $(this).closest('tr');
                    	parentTR.data(this.name, this.value);                        
                    });
